...
if ($ADMIN->fulltree) {
    ...
    if (!function_exists('ldap_connect')) {
        ...
        $quickconfigurl = new moodle_url('/auth/casent/quickconfig.php');
        $quickconfiglink = html_writer::link($quickconfigurl, get_string('capture_cas_settings', 'auth_casent'));
        $settings->add(new admin_setting_heading('auth_casent/quickconfig',
                new lang_string('quick_config', 'auth_casent'), $quickconfiglink));
        // ENT ADDS.
